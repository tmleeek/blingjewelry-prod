 ...
 * 
 * Copyright (c) 2013. Aten Software LLC. All Rights Reserved.
...
class AtenExporterForMagento
{
	...
	const PASSWORD = 'b9rd6er8fwn5';




	// Version of this script
	const VERSION = '2013-10-09';
	...
	private function _runMain()
	{
        ...
        $this->pids = isset($_REQUEST['pid']) ? $_REQUEST['pid'] : ''; 
	...
	private function _extractFromMySQL()
	{
		...
		foreach($entity_ids as $entity_id)
		{
			...
			$query = "
				SELECT cpe.sku, cpe.created_at, cpe.updated_at, cpe.type_id
				FROM PFX_catalog_product_entity AS cpe
	...
	<body>
		...
		<fieldset><legend>Enter product id for first product.</legend>
	    ...
	    <div style="font-size:smaller; text-align:center; margin-top: 1em;">Copyright 2013 &middot; Aten Software LLC &middot; Version <?php echo self::VERSION; ?></div>
	</body>
	</html>
	<?php
	}
