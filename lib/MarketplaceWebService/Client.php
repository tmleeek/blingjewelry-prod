...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
  ...
  private  $config = array ('ServiceURL' => null,
                            'UserAgent' => 'PHP Client Library/2010-11-01 (Language=PHP5)',
                            'SignatureVersion' => 2,
  ...
  const MWS_CLIENT_VERSION = '2010-11-01';
  
  const CONVERTED_PARAMETERS_KEY = 'PARAMETERS';
  const CONVERTED_HEADERS_KEY = 'HEADERS';
  ...
  private function getFormattedTimestamp($dateTime) {
    ...
    private function convertGetReport($request) {
      ...
      return array(CONVERTED_PARAMETERS_KEY => $parameters, CONVERTED_HEADERS_KEY => DEFAULT_HEADERS);
    }
