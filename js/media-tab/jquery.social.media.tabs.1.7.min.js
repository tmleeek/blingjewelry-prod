...
options,callback);s.data("socialtabs",d)}});return d};function createWidget(obj,type,id,o,w,h,share,tweetId){var ti=obj+"-"+type,c="",t="",p="",href="",n=o.limit,stream='<ul id="'+ti+'" class="stream"></ul>',data,frl="https://ajax.googleapis.com/ajax/services/feed/load?v=1.0";switch(type){case "twitter":var cp=id.split("/"),cq=id.split("#"),replies=o.replies==true?"&exclude_replies=false":"&exclude_replies=true";var param="&include_entities=true&include_rts="+o.retweets+replies;url=cp.length>1?o.url+
"?url=list&list_id="+cp[1]+"&per_page="+n+param:o.url+"?url=timeline&screen_name="+id+"&count="+n+param;if(cq.length>1){var rts=o.retweets==false?"+exclude:retweets":"";url=o.url+"?url=search&q="+encodeURIComponent(cq[1])+"&count="+n}href="https://www.twitter.com/";href+=cp.length>1||cq.length>1?o.followId:id;c+=stream;getFeed(ti,type,url,data,o,id,share,tweetId);break;case "facebook":c+=stream;url="https://www.facebook.com/feeds/page.php?id="+id+"&format=rss20";url=frl+"&num="+n+"&callback=?&q="+
encodeURIComponent(url);getFeed(ti,type,url,data,o,id,share,tweetId);break;case "fblike":src="https://www.facebook.com/plugins/likebox.php?id="+id+"&amp;width="+w+"&amp;connections="+n+"&amp;stream="+o.stream+"&amp;header="+o.header+"&amp;height="+h;c+=getFrame(src,w,h);break;case "fbrec":src="https://www.facebook.com/plugins/recommendations.php?site="+id+"&amp;width="+w+"&amp;height="+h+"&amp;header="+o.header+"&amp;colorscheme=light&amp;font&amp;border_color";c+=getFrame(src,w,h);break;case "google":href=
"https://plus.google.com/"+id;if(o.header>0){var ph=o.header==1?69:131;var gc=o.header==1?"small":"standard";c+='<link href="https://plus.google.com/'+o.pageId+'" rel="publisher" /><script type="text/javascript">window.___gcfg = {lang: "en"};(function(){var po = document.createElement("script");po.type = "text/javascript"; po.async = true;po.src = "https://apis.google.com/js/plusone.js";var s = document.getElementsByTagName("script")[0];s.parentNode.insertBefore(po, s);})();\x3c/script><div class="google-page '+
