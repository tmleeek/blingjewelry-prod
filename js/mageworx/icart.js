...
updateLinks:function(){
    ...
    /* mmc removing cart form updating
...
fade:function(el) {
    ...
    el.style.backgroundImage = 'url(/skin/frontend/rwd/blingjewelry/css/mageworx/spinner.gif)';
...
close:function(){
    Modalbox.hide({
        transitions:false // mmc removed transition
    });
},
