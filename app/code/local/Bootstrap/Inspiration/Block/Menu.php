<?php   
class Bootstrap_Inspiration_Block_Menu extends Mage_Core_Block_Template{   
   	...
   	public function _listMenu()
	{
		...
		$menu = Mage::getModel('inspiration/inspiration')->getCollection()
		...
		foreach($menu as $data)
		{
			...
			$url = 'inspiration/'. $data->getData('category');
