 ...
 *
 * @category    Bootstrap
 * @package     Bootstrap_CatalogOptionSortFix
 * @version     2014.12.15
 */
...
originally added code from Amasty_Xnotif_Block_Product_View_Type_Configurable to end of this class
which extended Mage_Catalog_Block_Product_View_Type_Configurable
now extending the Amasty_Xnotif_Block_Product_View_Type_Configurable instead of the Mage class
*/
class Bootstrap_CatalogOptionSortFix_Block_Product_View_Type_Configurable extends Amasty_Xnotif_Block_Product_View_Type_Configurable
{
    /**
