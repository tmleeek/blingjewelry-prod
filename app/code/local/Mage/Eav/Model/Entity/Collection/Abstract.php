...
abstract class Mage_Eav_Model_Entity_Collection_Abstract extends Varien_Data_Collection_Db
{
     ...
     * @var array
     */
	// Ashwani Bhasin 3-31-2014 added maxsize to limit the number of record lookup in new arrivals    
...
// BEGINS Ashwani Bhasin 3-31-2014 added maxsize to limit the number of record lookup in new arrivals    
...
// ENDS Ashwani Bhasin 3-31-2014 added maxsize to limit the number of record lookup in new arrivals    
...
// Following ifstatement has been disabled. replaced by new if.. Ashwani Bhasin 3-31-2014 added maxsize to limit the number of record lookup in new arrivals  
/*	if ($this->_pageSize) {
