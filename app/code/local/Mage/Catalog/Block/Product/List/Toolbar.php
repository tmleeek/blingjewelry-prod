...
class Mage_Catalog_Block_Product_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    public function setCollection($collection)
    {
        ...
        if ($this->getCurrentOrder()) {
            $this->_collection->setOrder(array($this->getCurrentOrder(), 'entity_id'), $this->getCurrentDirection()); //Ashwani Bhasin 1-29-2012 added entity id
        }
        return $this;
    }
    ...
    public function getAvailableOrders()
    {
		...
		//return $this->_availableOrder;  Ashwani Bhasin 4-13-2012 added entity id
    //Custom Order list Edit
    $this->_availableOrder = array(
        'position'  => $this->__('Editors Choice'),
        'entity_id' => $this->__('New Arrivals'),
        //'name' => $this->__('Name'),
        'price' => $this->__('Price')
    );
