...
class MageWorx_InstantCart_Helper_Data extends Mage_Core_Helper_Url
{
    ...
    const XML_SHOW_STATIC_BLOCK = 'mageworx_customers/icart/show_static_block';
    
    public function isEnabled() {
        return Mage::getStoreConfig(self::XML_ENABLED);        
    }
    
    public function getShowStaticBlock() {
        return Mage::getStoreConfig(self::XML_SHOW_STATIC_BLOCK);        
    }
    ...
    public function __js($str, $param=array()) {
        return $this->jsQuoteEscape(str_replace("\'", "'", $this->__($str, $param)));
    }
