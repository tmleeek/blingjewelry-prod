...
//      $config1 = 'catA' ;
    ...
    protected function getProductCollection()
    {
		...
		//added this 8-20-2012 ashwani bhasin to take care of the clearance page which did not show items. Direct mysql query showed duplicate ids in result
		->distinct(true);
