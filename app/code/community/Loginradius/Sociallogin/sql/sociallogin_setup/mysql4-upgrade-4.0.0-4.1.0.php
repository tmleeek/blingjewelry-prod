...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_basic_profile_data')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_emails')} (
  `user_id` int(11) NOT NULL,
  `email_type` varchar(10) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_contacts')} (
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_extended_location_data')} (
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_extended_profile_data')} (
    `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_positions')} (
    `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_companies')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_education')} (
	`user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_phone_numbers')} (
	`user_id` int(11) NOT NULL,
	`number_type` varchar(20) DEFAULT NULL,
	`phone_number` varchar(20) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_IMaccounts')} (
	`user_id` int(11) NOT NULL,
	`account_type` varchar(20) DEFAULT NULL,
	`account_username` varchar(100) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_addresses')} (
	`user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_sports')} (
	`user_id` int(11) NOT NULL,
	`sport_id` varchar(20) DEFAULT NULL,
	`sport` varchar(50) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_inspirational_people')} (
	`user_id` int(11) NOT NULL,
	`social_id` varchar(20) DEFAULT NULL,
	`name` varchar(50) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_skills')} (
	`user_id` int(11) NOT NULL,
	`skill_id` varchar(20) DEFAULT NULL,
	`name` varchar(50) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_current_status')} (
	`user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_certifications')} (
	`user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_courses')} (
	`user_id` int(11) NOT NULL,
	`course_id` varchar(30) DEFAULT NULL,
	`course` varchar(100) DEFAULT NULL,
	`course_number` varchar(50) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_volunteer')} (
	`user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_recommendations_received')} (
	`user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_languages')} (
	`user_id` int(11) NOT NULL,
	`language_id` varchar(30) DEFAULT NULL,
	`language` varchar(30) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_patents')} (
	`user_id` int(11) NOT NULL,
	`patent_id` varchar(30) DEFAULT NULL,
	`title` varchar(100) DEFAULT NULL,
	`date` varchar(30) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_favorites')} (
	`user_id` int(11) NOT NULL,
	`social_id` varchar(30) DEFAULT NULL,
	`name` varchar(100) DEFAULT NULL,
	`type` varchar(50) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_facebook_events')} (
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_facebook_posts')} (
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_groups')} (
  `user_id` int(11) NOT NULL,
  `provider` varchar(20) NOT NULL,
  `group_id` varchar(30) NOT NULL,
  `group_name` varchar(100) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_linkedin_companies')} (
  `user_id` int(11) NOT NULL,
  `company_id` varchar(20) NOT NULL,
  `company_name` varchar(200) DEFAULT NULL
);
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_status')} (
  `user_id` int(11) NOT NULL,
  `provider` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS {$this->getTable('loginradius_twitter_mentions')} (
  `user_id` int(11) NOT NULL,
