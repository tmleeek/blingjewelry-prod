<?php
class HusseyCoding_CartRuleFix_Model_SalesRuleValidator extends Mage_SalesRule_Model_Validator
{
    ...
    public function process(Mage_Sales_Model_Quote_Item_Abstract $item)
    {
        ...
        foreach ($this->_getRules() as $rule) {
            if (!empty($this->_stopFurtherRules[$item->getId()])) {
                break;
            }
            ...
            if ($rule->getStopRulesProcessing()) {
                $this->_stopFurtherRules[$item->getId()] = true;
                break;
            }
        }
        ...
        foreach ($this->_getRules() as $rule) {
            if (Mage_SalesRule_Model_Rule::CART_FIXED_ACTION == $rule->getSimpleAction()
                ...
                foreach ($items as $item) {
                    ...
                    $validItemsCount++;
                    $this->_stopFurtherRules[$item->getId()] = false;
                }
